...
export function ResponseViewer() {
  const { currentRequest, currentResponse, sendError, isSending, requestStartTime, requestPhase, updateRequest, setCurrentResponse, setSendError, beginRequestOperation, ownsRequestOperation, finishRequestOperation } = useRequestStore();
